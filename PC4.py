...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>Python x T/N 😍</h1>", unsafe_allow_html=True)
    ...
    col1.image("m864.jpg", caption='yo', width=300)
    ...
    st.markdown("<h2 style='text-align: center;'>Explicación de </h2>", unsafe_allow_html=True)
